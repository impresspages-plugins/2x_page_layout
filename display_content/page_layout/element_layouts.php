...
class ElementPages extends \Modules\developer\std_mod\Element { //data element in area
    ...
    function __construct($variables) {
        ...
        $this->recordToOptionTable = 'm_display_content_page_layout_to_page';
        $this->recordToOptionRecordReference = 'layoutId';
    ...
    */
    private function _getOptions($parent = null, $prefix = '') {
        ...
        $tmpExcludedZones = explode("\n", $parametersMod->getValue('display_content', 'page_layout', 'options', 'excluded_zones'));
        $excludedZones = array();
